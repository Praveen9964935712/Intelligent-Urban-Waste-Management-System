...
import {
  getStaffComplaintDetail, getStaffComplaints, getStaffProfile, getStaffTasks,
  updateStaffAvailability, updateStaffTaskNotes, updateStaffTaskStatus,
...
function StaffDashboard() {
  ...
  const loadDashboard = async () => {
    ...
    try {
      const [profileData, taskData, complaintData] = await Promise.all([getStaffProfile(), getStaffTasks(), getStaffComplaints()]);
      setProfile(profileData); setTasks(taskData || []); setComplaints(complaintData || []);
    } catch (requestError) {
